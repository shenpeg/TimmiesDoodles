...
class App(object):
    ...
    def __init__(app, width=300, height=300, x=0, y=0, title=None, autorun=True, mvcCheck=True, logDrawingCalls=True):
        ...
        app.mouseMovedDelay = 1 # CHANGED TO LESS DELAY
        app._title = title
    ...
    def getSnapshot(app):   # EDITED
        app._showRootWindow()
        x0 = app._root.winfo_rootx() + app._canvas.winfo_x() + 60
        y0 = app._root.winfo_rooty() + app._canvas.winfo_y() + 130
